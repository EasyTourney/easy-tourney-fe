  ...
  return (
    ...
    >
      ...
      <Box
        ...
        style={{
          opacity: leaderboardData.teamsTop2.length === 0 ? 0.4 : 1
        }}
      >
        {/* POSITION */}
        ...
        <Box className={styles['detail-container2']}>
          <Box className={styles['detail-wrapper2']}>
            ...
            <Typography className={styles['detail-value2']}>{leaderboardData.teamsTop2[0]?.theDifference}</Typography>
          </Box>
          <Divider />
          <Box className={styles['detail-wrapper2']}>
          ...
          <Box className={styles['detail-wrapper2']}>
            ...
            <Typography className={styles['detail-value2']}>{leaderboardData.teamsTop2[0]?.negativeResult}</Typography>
          </Box>
        </Box>
      ...
      <Box
        ...
        style={{
          opacity: leaderboardData.teamsTop1.length === 0 ? 0.4 : 1
        }}
      >
        {/* POSITION */}
        ...
        <Box className={styles['detail-container1']}>
          <Box className={styles['detail-wrapper1']}>
            ...
            <Typography className={styles['detail-value1']}>{leaderboardData.teamsTop1[0]?.theDifference}</Typography>
          </Box>
          <Divider />
          <Box className={styles['detail-wrapper1']}>
          ...
          <Box className={styles['detail-wrapper1']}>
            ...
            <Typography className={styles['detail-value1']}>{leaderboardData.teamsTop1[0]?.negativeResult}</Typography>
          </Box>
        </Box>
        <Box className={styles['point-container']}>
      ...
      <Box
        ...
        style={{
          opacity: leaderboardData.teamsTop3.length === 0 ? 0.4 : 1
        }}
      >
        {/* POSITION */}
        ...
        <Box className={styles['detail-container3']}>
          <Box className={styles['detail-wrapper3']}>
            ...
            <Typography className={styles['detail-value3']}>{leaderboardData.teamsTop3[0]?.theDifference}</Typography>
          </Box>
          <Divider />
          <Box className={styles['detail-wrapper3']}>
          ...
          <Box className={styles['detail-wrapper3']}>
            ...
            <Typography className={styles['detail-value3']}>{leaderboardData.teamsTop3[0]?.negativeResult}</Typography>
          </Box>
        </Box>
        <Box className={styles['point-container']}>
